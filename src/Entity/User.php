 ...
 * @UniqueEntity(
 *     fields={"email"},
 *     message="Cette adresse mail a déjà été utilisé, merci de la modifier ou de vous connectez à votre compte"
 * )
 */
class User implements UserInterface
{
     ...
     * @Assert\Url(message="Veuillez renseigner un url valide pour votre avatar")
     */
    private $picture;
    ...
    /**
     * @Assert\EqualTo(propertyPath="hash", message="Le mot de passe de confirmation saisie est incorrect")
     */
